module Day17
    ...
    let rec foo grid goal seen (pq : PriorityQueue<Node', int>) maxConsecutiveBlocks minStretch =
        ...
        | (true, node, _) -> 
            ...
            | false ->
                ...
                | false -> 
                    ...
                    |> ignore
                    foo grid goal seen' pq maxConsecutiveBlocks minStretch
